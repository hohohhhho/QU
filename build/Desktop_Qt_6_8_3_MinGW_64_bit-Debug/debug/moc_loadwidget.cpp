...
namespace {
struct qt_meta_tag_ZN10LoadWidgetE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10LoadWidgetE = QtMocHelpers::stringData(
    "LoadWidget",
    "finished",
    "",
    "changeProgress",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10LoadWidgetE[] = {
...
Q_CONSTINIT const QMetaObject LoadWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10LoadWidgetE.offsetsAndSizes,
    qt_meta_data_ZN10LoadWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10LoadWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void LoadWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (LoadWidget::*)();
            if (_q_method_type _q_method = &LoadWidget::finished; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *LoadWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10LoadWidgetE.stringdata0))
