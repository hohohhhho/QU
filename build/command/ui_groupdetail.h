...
public:
    ...
    void setupUi(QWidget *GroupDetail)
    {
        ...
        btn_left = new QPushButton(widget_4);
        btn_left->setObjectName("btn_left");
        QSizePolicy sizePolicy4(QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Minimum);
        sizePolicy4.setHorizontalStretch(0);
        sizePolicy4.setVerticalStretch(0);
        sizePolicy4.setHeightForWidth(btn_left->sizePolicy().hasHeightForWidth());
        btn_left->setSizePolicy(sizePolicy4);

        horizontalLayout->addWidget(btn_left);

        btn_right = new QPushButton(widget_4);
        btn_right->setObjectName("btn_right");
        sizePolicy4.setHeightForWidth(btn_right->sizePolicy().hasHeightForWidth());
        btn_right->setSizePolicy(sizePolicy4);
    ...
    void retranslateUi(QWidget *GroupDetail)
    {
        ...
        btn_left->setText(QCoreApplication::translate("GroupDetail", "\350\257\267\346\261\202\345\212\240\345\205\245", nullptr));
        btn_right->setText(QCoreApplication::translate("GroupDetail", "\345\217\221\351\200\201\346\266\210\346\201\257", nullptr));
    } // retranslateUi
