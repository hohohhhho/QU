...
#include "../../../../../login_widget/mybutton.h"
...
static constexpr auto qt_meta_stringdata_ZN8MyButtonE = QtMocHelpers::stringData(
    "MyButton",
    "clicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8MyButtonE[] = {
...
Q_CONSTINIT const QMetaObject MyButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8MyButtonE.offsetsAndSizes,
    qt_meta_data_ZN8MyButtonE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8MyButtonE_t,
        // Q_OBJECT / Q_GADGET
...
void MyButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (MyButton::*)();
            if (_q_method_type _q_method = &MyButton::clicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *MyButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8MyButtonE.stringdata0))
