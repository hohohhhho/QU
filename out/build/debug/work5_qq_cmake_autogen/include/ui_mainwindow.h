...
public:
    ...
    AutoRotateButton *btn_friend_refresh;
    ...
    AutoRotateButton *btn_group_refresh;
...
"}"));
        ...
        scrollArea_friend->setVerticalScrollBarPolicy(Qt::ScrollBarPolicy::ScrollBarAsNeeded);
        scrollArea_friend->setHorizontalScrollBarPolicy(Qt::ScrollBarPolicy::ScrollBarAlwaysOff);
        ...
        verticalLayout_4->setContentsMargins(0, 0, 3, 0);
        ...
        sizePolicy2.setHeightForWidth(edit_seek_friend->sizePolicy().hasHeightForWidth());
        edit_seek_friend->setSizePolicy(sizePolicy2);
        ...
        sizePolicy1.setHeightForWidth(btn_seek_friend->sizePolicy().hasHeightForWidth());
        btn_seek_friend->setSizePolicy(sizePolicy1);

        horizontalLayout_5->addWidget(btn_seek_friend);

        btn_friend_refresh = new AutoRotateButton(scrollAreaWidgetContents_friend);
        btn_friend_refresh->setObjectName("btn_friend_refresh");
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/res/refresh.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        btn_friend_refresh->setIcon(icon4);
        btn_friend_refresh->setIconSize(QSize(16, 16));

        horizontalLayout_5->addWidget(btn_friend_refresh);
        ...
        scrollArea_preview->setVerticalScrollBarPolicy(Qt::ScrollBarPolicy::ScrollBarAsNeeded);
        scrollArea_preview->setHorizontalScrollBarPolicy(Qt::ScrollBarPolicy::ScrollBarAlwaysOff);
        ...
        sizePolicy3.setHeightForWidth(scrollAreaWidgetContents_preview->sizePolicy().hasHeightForWidth());
        scrollAreaWidgetContents_preview->setSizePolicy(sizePolicy3);
...
"}"));
        ...
        scrollArea_group->setVerticalScrollBarPolicy(Qt::ScrollBarPolicy::ScrollBarAsNeeded);
        scrollArea_group->setHorizontalScrollBarPolicy(Qt::ScrollBarPolicy::ScrollBarAlwaysOff);
        ...
        sizePolicy2.setHeightForWidth(edit_seek_group->sizePolicy().hasHeightForWidth());
        edit_seek_group->setSizePolicy(sizePolicy2);
        ...
        sizePolicy1.setHeightForWidth(btn_seek_group->sizePolicy().hasHeightForWidth());
        btn_seek_group->setSizePolicy(sizePolicy1);

        horizontalLayout_8->addWidget(btn_seek_group);

        btn_group_refresh = new AutoRotateButton(scrollAreaWidgetContents_group);
        btn_group_refresh->setObjectName("btn_group_refresh");
        btn_group_refresh->setIcon(icon4);
        btn_group_refresh->setIconSize(QSize(16, 16));

        horizontalLayout_8->addWidget(btn_group_refresh);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btn_friend_refresh->setText(QString());
        ...
        btn_group_refresh->setText(QString());
